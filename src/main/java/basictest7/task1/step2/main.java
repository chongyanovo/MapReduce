...
public class main {
    public static Path INPUT_PATH1 = new Path("hdfs://localhost:9000/Q1/input/product.txt");
    public static Path INPUT_PATH2 = new Path("hdfs://localhost:9000/Q1/output1/part-r-00000");
    public static Path OUTPUT_PATH = new Path("hdfs://localhost:9000/Q1/output2");
